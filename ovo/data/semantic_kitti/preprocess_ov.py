...
from monoscene.data.NYU.preprocess_ori import _downsample_label
...
def main(config: DictConfig):
    ...
    for sequence in sequences:
        ...
        out_dir = os.path.join(
            config.kitti_preprocess_root, "labels", sequence)
        ...
        for i in tqdm(range(len(label_paths))):
            ...
            frame_id, extension = os.path.splitext(
                os.path.basename(label_paths[i]))
