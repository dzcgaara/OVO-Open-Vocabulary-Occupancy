...
import numpy as np
from ovo.models.CRP3D import CPMegaVoxels
from ovo.models.modules import (
    Process,
    Upsample,
    Downsample,
    SegmentationHead,
...
class UNet3D(nn.Module):
    def __init__(
        ...
        if with_ovhead:
            self.ovhead = OVheadV2(num_queries = 50)

    def forward(self, input_dict, with_ov_bbox = False):
        res = {}
